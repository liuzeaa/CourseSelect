...
const COURSE_INDEX_MAP = {
  ...
  '15:05~17:30': [7, 8, 9],
  '18:30~20:05': [10, 11],
  '18:30~20:55': [10, 11, 12]
};

export const getCourseDayIndex = value => {
  return COURSE_DATE.indexOf(value);
};

export const getCourseTimeIndex = value => {
  return COURSE_INDEX_MAP[value];
};
